namespace AuctionSystem.Infrastructure.Identity
{
    ...
    public class UserManagerService : IUserManager
    {
        ...
        {
            var saldoUser = await this.context
                .SaldoUsers
        ...
        private async Task<RefreshToken> GetLastValidToken(string currentUserId, CancellationToken cancellationToken)
            => await this.context.RefreshTokens.SingleOrDefaultAsync(
                ...
                cancellationToken);
        private async Task<SaldoUser> GetLastBalance(string currentUserId, CancellationToken cancellationToken)
    => await this.context.SaldoUsers.SingleOrDefaultAsync(
